		  ...
		  <div class="row">
		    ...
		    <div class="col">
		      <h1>Review</h1>
			     ...
			     <button type="button" class="btn" name="angry" value="angry"> 
				 ...
				 <button type="button" class="btn" name="neutral" value="neutral"> 
				 ...
				 <button type="button" class="btn" name="heartEyes" value="heartEyes"> 
				 ...
				 <script>
				 var emoji = $('.btn.active').attr("value");
				 </script>
				 <!-- onclick 속성값 얻기 -->
				 <br/>
