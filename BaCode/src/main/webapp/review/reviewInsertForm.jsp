		  ...
		  <div class="row">
		    ...
		    <div class="col">
		      <h1 style="color: #3E408F;">리뷰 쓰기</h1>
			     ...
			     <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" onclick="emoji('1')" value="angry">
				 ...
				 <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" onclick="emoji('2')" value="neutral">
				 ...
				 <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" onclick="emoji('3')" value="heartEyes">
