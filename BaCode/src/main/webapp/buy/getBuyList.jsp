...
<body>
	<h1 style="color: #3E408F;">구매 목록</h1>
    ...
    <nav aria-label="Page navigation example">
          ...
          <c:if test="${buttons.startPage ne 1}">
		    <li class="page-item"><a class="page-link" href="http://localhost:52525/BaCode/getBuyList.buy?pageNum=${buttons.startPage-1 }" style="color: #8789C6; ">Previous</a></li>
		  </c:if>
		    <c:forEach var="pageNum" begin="${buttons.startPage }" end="${buttons.endPage }"> 
				    <li class="page-item ${(buttons.currentPage eq pageNum) ? 'active' : ' '}" aria-current="page"><a class="page-link" href="http://localhost:52525/BaCode/getBuyList.buy?pageNum=${pageNum}" style="color: #8789C6; ">${pageNum }</a></li>
		    </c:forEach> 
          <c:if test="${buttons.endPage ne buttons.totalPages}">
		    <li class="page-item"><a class="page-link" href="http://localhost:52525/BaCode/getBuyList.buy?pageNum=${buttons.endPage+1 }" style="color: #8789C6; ">Next</a></li>
		  </c:if>
		  </ul>
	</nav>
